...
userRouter.get("/fetchChat", useController.fetchChat);
userRouter.post("/sendFile",upload.single('file'),useController.sendFile)
...
userRouter.get('/updateReadStatus',useController.updateReadStatus)
userRouter.get('/fetchGroupMembers',useController.fetchGroupMembers)
